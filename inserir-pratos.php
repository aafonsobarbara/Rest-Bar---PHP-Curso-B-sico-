    ...
    if ($db_connect->connect_error) {
        ...
        foreach ($pratos as $prato) {
            ...
            $sql = "INSERT INTO pratos(codigo, nome, categoria, descricao, preco, calorias, destaque) VALUES ('$codigo', '$nome', '$categoria', '$desc', '$preco', '$calorias', '$destaque')";

            if ($db_connect->query($sql)) {
                echo $nome . "inserido com sucesso" . '<br><br>';
            } else {
                echo "Nao foi possivel inserir " . $nome  . '<br>';
